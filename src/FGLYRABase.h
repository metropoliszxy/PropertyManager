...
#define ID_JSBBASE "$Id: FGLYRABase.h,v 1.44 2015/09/17 19:44:13 bcoconni Exp $"
...
*   functions, and enumerated constants to LYRASim.
    @author Jon S. Berndt
    @version $Id: FGLYRABase.h,v 1.44 2015/09/17 19:44:13 bcoconni Exp $
*/
...
class FGLYRABase {
public:
  /// Constructor for FGLYRABase.
  FGLYRABase() {};

  /// Destructor for FGLYRABase.
  virtual ~FGLYRABase() {};

  /// LYRASim Message structure
  class Message {
  public:
    unsigned int fdmId;
  ...
  ///@name LYRASim console output highlighting terms.
  //@{
  /// highlights text
  ...
  ///@name LYRASim Messaging functions
  //@{
  ...
  /** Returns the version number of LYRASim.
  *   @return The version number of LYRASim. */
  std::string GetVersion(void) {return LYRASim_version;}
...
protected:
  ...
  static const std::string LYRASim_version;
